...
public class CatalogActivity extends AppCompatActivity {
    ...
    private void insertPet(){
        ...
        // First create content values object
        ...
        // Insert the new row and capture the the primary key value of the new row
        long newRowId = db.insert(PetsEntry.TABLE_NAME,null,values);

        // This log can help us catcha ny potential errors.
